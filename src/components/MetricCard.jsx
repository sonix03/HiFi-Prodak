...
export default function MetricCard({ label, value, sub, icon: Icon, tone = "orange", progress }) {
  const tones = {
    orange: "bg-[var(--primary-soft)] text-[var(--primary)]",
  ...
  return (
    <Card className="min-w-0">
      <div className="between">
        ...
        {Icon ? <span className={`grid h-9 w-9 place-items-center rounded-xl ${tones[tone]}`}><Icon size={17} /></span> : null}
      </div>
